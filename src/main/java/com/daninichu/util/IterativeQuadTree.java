...
public class IterativeQuadTree<T> {
    ...
    public IterativeQuadTree(Rectangle2D bounds, int maxDepth) {
     ...
     */
    public IterativeQuadTree(double x, double y, double width, double height) {
     ...
     */
    public IterativeQuadTree(double x, double y, double width, double height, int maxDepth) {
    ...
    public Entry<T> add(T value, double x, double y, double width, double height){
        ...
        double childW = quadrant.w / 2;
        double childH = quadrant.h / 2;
...
//    }
    ...
    public static class Entry<T>{
        ...
        private IterativeQuadTree<T> owner;
