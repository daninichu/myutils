...
public class HashGrid5<E> extends AbstractGrid<E> implements Grid<E>{
    ...
    public HashGrid5(int initialCapacity){
        init(tableSizeFor(initialCapacity));
    }

    public HashGrid5(Grid<? extends E> grid){
        init(DEFAULT_CAPACITY);
        setAll(grid);
    }
    ...
    public void setAll(Grid<? extends E> grid){
        if(grid instanceof HashGrid5<? extends E> other){
    ...
    public boolean equals(Object obj){
        ...
        if(!(obj instanceof HashGrid5<?> other)) return false;
